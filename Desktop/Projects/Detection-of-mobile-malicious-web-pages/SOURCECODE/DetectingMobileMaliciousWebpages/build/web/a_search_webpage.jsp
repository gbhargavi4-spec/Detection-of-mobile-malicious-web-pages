...
<body>
       ...
       <%
        ...
        <script>alert('Request is Forwarded to Admin');</script>
        <% }
...
<form name="s" action="a_search_webpage.jsp" method="post" onSubmit="return valid()"  ons target="_top">   
         ...
         <table align="center">
              <tr>
			   ...
			   <tr>
                ...
                <p>
            <div align="center" class="style5 style14"><span class="style11">  <a href="a_search_webpage1.jsp?tn=<%=s2%>&rank=<%=UpdateRank%>&count=0">View Details </a></span></div>
                </p>
                <p></p>
				<div>
